...
public class MainWindow extends JFrame{
	...
	private void initGUI() {
        ...
        //Panel empleado
        empleado = EmpleadoGUI.getInstance().getPanelEmpleado();
        jTabbedPane.addTab("Empleado", empleado);
        
        //Panel departamento
        departamento = DepartamentoGUI.getInstance().getPanelDepartamento();
        jTabbedPane.addTab("Departamento", departamento);
        
        //Panel proveedor
        proveedor = ProveedorGUI.getInstance().getPanelProveedor();
        jTabbedPane.addTab("Proveedor", proveedor);
