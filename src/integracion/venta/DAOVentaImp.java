...
public class DAOVentaImp implements DAOVenta{
	...
	public boolean auxActualizarStock(TransferProducto p) throws Excepciones {
	...
	public boolean auxActualizarTotalVenta(TransferVenta v, boolean esDevolucion) throws Excepciones {
	...
	public boolean auxActualizarLineaVenta(TransferLineaVenta lv, int IDVenta) throws Excepciones {
